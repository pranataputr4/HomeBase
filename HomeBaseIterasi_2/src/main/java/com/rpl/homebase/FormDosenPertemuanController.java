 ...
 * @author Doni
 */
public class FormDosenPertemuanController implements Initializable {

    private Jadwal jadwalSession;
    private Pertemuan pertemuanSession;
    
    @FXML
    private AnchorPane formDosenPertemuan;
    @FXML
    ...
    private void btnBack(ActionEvent event) throws IOException {
        ...
        sp.switchPane(formDosenPertemuan,"dashDosenPresensi");
    }
    ...
    private void btnPresensi(ActionEvent event) throws IOException, SQLException {
        ...
        SwitchPane sp = new SwitchPane();
        sp.switchPane(formDosenPertemuan,"formDosenPresensi");
    }
