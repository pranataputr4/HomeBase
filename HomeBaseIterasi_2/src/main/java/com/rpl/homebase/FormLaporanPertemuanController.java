 ...
 * @author Pranata
 */
public class FormLaporanPertemuanController implements Initializable {

    private Jadwal jadwalSession;
    
    @FXML
    private AnchorPane formLaporanPertemuan;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(FormLaporanPertemuanController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }    
    ...
    private void btnBack(ActionEvent event) throws IOException {
        ...
        sp.switchPane(formLaporanPertemuan,"dashAdminLaporan");
    }
